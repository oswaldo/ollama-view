...
- [x] Task: Write E2E tests for importing a chat via Command Palette and verifying it appears in the panel.
- [x] Task: Write E2E tests for collision handling prompts and best-effort import warnings during the import process.
